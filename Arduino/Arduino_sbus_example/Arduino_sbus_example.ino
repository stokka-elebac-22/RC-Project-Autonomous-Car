...
//     myservo8.attach(8);  // attaches the servo on pin 8 to the servo object
     ...
     mySerial.begin(100000); //The SBUS is a non standard baud rate which can be confirmed using an oscilloscope  
  }
  ...
  if (mySerial.available ()) {
    ...
    if (idx == 25) {  // If we've got 25 bytes then this is a good package so start to decode
      ...
      } else 
      {
            ...
            Serial.print("Red 5, green 6, blue 7");
            Serial.println(RedLed & GreenLed & BlueLed);

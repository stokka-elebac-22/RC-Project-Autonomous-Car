...
if __name__ == "__main__":
    ...
    while RUN:
        ...
        temp_path = [(path[0][1], BOARD_SIZE[0] - (path[0][0]+1))]
        temp_path = temp_path + new_path
        temp_path.append((path[len(new_path) - 1][1], BOARD_SIZE[0] - (path[len(new_path) - 1][0]+1)))

        c = CatmullRomChain(temp_path, a)

...
class PathFinding:
    ...
    def catmull_rom_spline(self, p_0, p_1, p_2, p_3, alpha, num_points=100): # pylint: disable=R0913 R0914
        '''
    ...
    def catmull_rom_chain(self, points, alpha, num_points=100):
        '''
        ...
        for i in range(len(points)-3):
            c_value, d_value = self.catmull_rom_spline(
    ...
    def calculate_path(self, start_object: int, end_object: int) -> dict:
        ...
        if path:
            ...
            temp_path.reverse()
            curve, _ = self.catmull_rom_chain(temp_path, self.tension, self.num_points)

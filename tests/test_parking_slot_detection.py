...
class TestParametrized:
    ...
    ([np.array((20, 120, 400, 20)), np.array((20, 120, 400, 20)), np.array((123, 232, 234, 100))], 
    ...
    @pytest.mark.parametrize('lines, coords, slope, intercept, expected', [
        ([[-1, 100], [1, 2]], [[123, 123, 321, 321], [123, 123, 321, 321]], 1, 1, [[[-1, 100]], [[123, 123, 321, 321]]]),
        ([[-1, 100], [1, 200]], [[123, 123, 321, 321], [123, 123, 321, 321]], 1, 1, [[[-1, 100], [1, 200]], [[123, 123, 321, 321], [123, 123, 321, 321]]])
    ])
    ...
    def test_detect_parking_lines(self, img_source, qr_size_px, qr_size_mm, qr_distance):
        ...
        parking_slot_detector = ParkingSlotDetector()
        lines = parking_slot_detector.detect_parking_lines(image, qr_size_px, qr_size_mm, qr_distance)
        assert len(lines) > 0
    ...
    def test_get_line_coordinates_from_parameters(self, min_x, max_x, line_parameters, expected):
        ...
        parking_slot_detector = ParkingSlotDetector()
        line_coordinates = parking_slot_detector.get_line_coordinates_from_parameters(min_x, max_x, line_parameters)
